...
type
    PMatrix = ^TMatrix;
    TMatrix = Array[0..511, 0..511] of Int32;
...
procedure PrintMatrix(M: PMatrix; dim: Int32);
var i, j: Int32;
begin
    for i := 0 to dim - 1 do
    begin
...
function Add(A, B: PMatrix; dim: Int32): PMatrix;
var i, j: Int32;
begin
    New(Add);
    for i := 0 to dim - 1 do
...
function Sub(A, B: PMatrix; dim: Int32): PMatrix;
var i, j: Int32;
begin
    New(Sub);
    for i := 0 to dim - 1 do
...
function Quadrant(M: PMatrix; x, y: Int32; dim: Int32): PMatrix;
var N, i, j: Int32;
begin
    New(Quadrant);
    N := dim div 2;
...
function Merge(Q11, Q12, Q21, Q22: PMatrix; dim: Int32): PMatrix;
var i, j: Int32;
begin
    New(Merge);
    for i := 0 to dim - 1 do
...
function Strassen(A, B: PMatrix; dim: Int32): PMatrix;
var i, j, k: Int32;
